...
6. connexion.php
7. profil.php
8. gestion_boutique / formulaire_produit.php
9. gestion_membres.php
10.index.php
11.fiche_produit.php
12.panier.php
...
// DISTINCT pour dédoublonner les catégories

$contenu_categories .= '<div class="list-group mb-4">';

$contenu_categories .= '<a href="?categorie=tous" class="list-group-item list-group-item-action">Tous les produits :</a>';
// on passe dans l'URL que cette catégorie a pour valeur "tous" pour afficher tous les produits

while ($cat = $resultat->fetch(PDO::FETCH_ASSOC)) {
    //debug($cat); // est un tableau avec l'indice "categorie" qui contient  une catégorie différente par tour de boucle
