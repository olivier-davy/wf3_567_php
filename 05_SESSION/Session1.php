...
//-------------------------
// Principe des sessions : un fichier temporaire appelé "session" est créé sur le serveur avec un identifiant unique. Cette session est liéé à un internaute car dans le même temps est déposé dans son navigateur avec l'identifiant (au nom de PHPSESSID). Ce cookie se détruit lorsque l'on quitte le navigateur.
...
// Les données du fichiers de session sont accessibles et manipulables à partir de la superglobale $_SESSION.
...
$_SESSION['mdp'] = 'milou'; // $_SESSION étant SG, c'est un array. On accède donc à ses valeurs en passant par les indices écrits entre []
...
unset($_SESSION['mdp']); // nous supprimons le mdp avec unset().
