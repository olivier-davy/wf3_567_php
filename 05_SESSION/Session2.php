...
// Ce fichier session2.php n'a pas de lien avec le précédent, il n'y a pas d'inclusion, il pourrait être dans n'importe quel dossier, sappeler n'importe comment, les données contenues restent accessibles grâce à la session.
